...
const HeroSection = () => {
  return (
    <section className="w-full h-fit flex flex-col justify-center items-center bg-[#ffffff00] py-12 px-30 gap-8 ">
      ...
      <div className='w-[80%] font-300 text-xs text-[#232323] flex flex-row justify-between items-center gap-2'>
        ...
        <div className='w-fit p-6 flex flex-row justify-center items-center bg-blue/20 backdrop-blur-xl border border-white/50 rounded-2xl shadow-xl'>
